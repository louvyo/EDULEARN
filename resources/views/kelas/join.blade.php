    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg mb-4">
                ...
                <div class="p-8">
                    <form action="{{ route('kelas.join.submit') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="kode_kelas" id="kode_kelas" maxlength="8"
                                ...
                                value="{{ old('kode_kelas') }}" required autofocus>
                            @error('kode_kelas')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-2 text-xs text-gray-500 text-center">Kode kelas terdiri dari 8 karakter (huruf dan
                                angka)</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-t border-gray-100">
                    ...
                    <ol class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-start">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs mr-3 flex-shrink-0">1</span>
                            <span>Dapatkan kode kelas dari guru Anda (8 karakter huruf/angka)</span>
                        </li>
                        <li class="flex items-start">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs mr-3 flex-shrink-0">2</span>
                            <span>Masukkan kode kelas pada kolom di atas</span>
                        </li>
                        <li class="flex items-start">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs mr-3 flex-shrink-0">3</span>
                            <span>Tunggu persetujuan dari guru sebelum bisa mengakses kelas</span>
                        </li>
                        <li class="flex items-start">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs mr-3 flex-shrink-0">4</span>
