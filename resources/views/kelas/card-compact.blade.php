@php
    ...
    if ($isCustomColor) {
        ...
        $colorMap = [
            'blue' => ['from' => '#3b82f6', 'to' => '#1e40af', 'accent' => '#60a5fa'],
            'green' => ['from' => '#10b981', 'to' => '#065f46', 'accent' => '#34d399'],
            'purple' => ['from' => '#a855f7', 'to' => '#6b21a8', 'accent' => '#c084fc'],
            'red' => ['from' => '#ef4444', 'to' => '#991b1b', 'accent' => '#f87171'],
            'yellow' => ['from' => '#f59e0b', 'to' => '#b45309', 'accent' => '#fbbf24'],
            'pink' => ['from' => '#ec4899', 'to' => '#9f1239', 'accent' => '#f472b6'],
        ];
   ...
   style="background: {{ $bgGradient }};">
    ...
    <div class="relative">
        ...
        <div class="relative p-6 text-white">
            <!-- Header -->
            <div class="mb-4">
                <h3 class="text-xl font-bold mb-1.5 drop-shadow-md transition-all duration-300 group-hover:drop-shadow-lg group-hover:translate-x-1">
                    {{ $title }}
                </h3>
                <div class="flex items-center gap-2 text-sm opacity-90 group-hover:opacity-100 transition-all duration-300">
                ...
                <div class="flex items-center gap-2 text-xs mt-1 opacity-80 group-hover:opacity-100 transition-all duration-300">
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-semibold uppercase tracking-wider opacity-90 group-hover:opacity-100 transition-opacity duration-300">Progress Kelas</span>
                    <span class="text-lg font-bold drop-shadow-lg transition-all duration-300 group-hover:scale-110">{{ $progress }}%</span>
                </div>
                <div class="w-full bg-white/20 backdrop-blur-sm rounded-full h-2.5 overflow-hidden shadow-inner group-hover:bg-white/30 transition-colors duration-300">
                    <div class="h-2.5 rounded-full transition-all duration-[1500ms] ease-out shadow-lg"
                        data-progress="{{ $progress }}"
                        style="width: 0%; background: white;">
                    </div>
                </div>
            </div>
        </div>
