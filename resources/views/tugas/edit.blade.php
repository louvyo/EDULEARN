            ...
            <form action="{{ route('tugas.update', $tugas->id) }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="judul" name="judul" value="{{ old('judul', $tugas->judul) }}"
                        ...
                        placeholder="Contoh: Tugas Matematika - Persamaan Linear" required>
                    @error('judul')
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="6"
                        ...
                        placeholder="Tuliskan deskripsi atau instruksi tugas secara detail..." required>{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="poin" name="poin" value="{{ old('poin', $tugas->poin) }}"
                            min="0" max="100"
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-gray-100">
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-sm hover:shadow-md hover:scale-105">
                    ...
                    <a href="{{ route('tugas') }}"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-semibold hover:bg-gray-200 transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
